...
def calculate_demographic_data(print_data=True):
    ...
    percentage_bachelors = round(100*(df['education']=='Bachelors').sum()/len(df),1)
    ...
    higher_education_rich = round(100* (df[higher_education]['salary']=='>50K').mean(),1)
    lower_education_rich = round(100* (df[lower_education]['salary']=='>50K').mean(),1)
